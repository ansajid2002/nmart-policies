...
<h1  className=" text-3xl md:text-5xl">Privacy Policy</h1>
    ...
    <h3 className="text-xl md:text-4xl">Types of Data Collected</h3>
    <h4>Personal Data</h4>
    ...
    <h3 className="text-xl md:text-4xl">Use of Your Personal Data</h3>
    ...
    <h3 className="text-xl md:text-4xl">Retention of Your Personal Data</h3>
    ...
    <h3 className="text-xl md:text-4xl">Transfer of Your Personal Data</h3>
    ...
    <h3 className="text-xl md:text-4xl">Delete Your Personal Data</h3>
    ...
    <h3 className="text-xl md:text-4xl">Disclosure of Your Personal Data</h3>
    ...
    <h3 className="text-xl md:text-4xl">Security of Your Personal Data</h3>
